...
import { DbTransaction } from '@/presentation/contracts/db-transaction'

import { createConnection, getConnection, getConnectionManager, ObjectType, QueryRunner, Repository, Connection, getRepository, EntityTarget } from 'typeorm'
...
export class PgConnection implements DbTransaction {
  ...
  getRepository<Entity> (entity: ObjectType<Entity | EntityTarget<Entity>>): Repository<Entity | any> {
    if (this.connection === undefined) throw new ConnectionNotFoundError()
